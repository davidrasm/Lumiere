 ...
 * Modified for multi-site finess model (April., 2018)
 *
 */
...
@Description("Alignment based on a filter operation on another alignment"  +
		"Same as FilteredAlignment in beast.evolution.alignment but does not sort sites by site patterns")
public class UnsortedFilteredAlignment extends Alignment {
    ...
    public UnsortedFilteredAlignment() {
    ...
    protected void calcPatterns() {
        ...
        //Arrays.sort(data, comparator); // Don't sort sites by site patterns
