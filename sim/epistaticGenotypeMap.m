classdef epistaticGenotypeMap
    ...
    methods
        ...
        function obj=epistaticGenotypeMap(fitMtrx,params)
            ...
            obj.fitVals(1) = params.epiFitness; % fitness of double mutant can be arbitrary
